...
describe('POST /register', () => {
    ...
    describe('Quando o campo "username" é menor que 3 caracteres', () => {
        it('Deve retornar um status 409', () => __awaiter(void 0, void 0, void 0, function* () {
            const httpResponse = yield chai_1.default
                .request(app_1.app)
                .post('/register')
    ...
    describe('Quando o campo "password" não contém um numero', () => {
        it('Deve retornar um status 409', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, chai_1.expect)(httpResponse.status).to.equal(http_status_codes_1.StatusCodes.CONFLICT);
            (0, chai_1.expect)(httpResponse.body).to.deep.equal({ error: 'O campo "password" deve ter um numero' });
        }));
    });
    describe('Quando o campo "password" não contém uma letra maiuscula', () => {
        it('Deve retornar um status 409', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, chai_1.expect)(httpResponse.status).to.equal(http_status_codes_1.StatusCodes.CONFLICT);
            (0, chai_1.expect)(httpResponse.body).to.deep.equal({ error: 'O campo "password" deve ter uma letra maiuscula' });
        }));
    });
    ...
    describe('Quando a requisição é feita com sucesso', () => {
        ...
        it('Deve retornar um status 201', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, chai_1.expect)(httpResponse.body).to.have.all.keys(['id', 'username']);
        }));
    });
});
